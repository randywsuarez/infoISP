				...
				<q-card dark flat bordered style="width: 95%" class="bg-dark text-white inset-shadow q-ma-md">
					...
					<q-card-section class="row col q-pt-none">
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.sku" label="Product Number" readonly />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.serial" label="Serial Number" readonly />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.product" label="Product" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input
								dark
						...
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.cpu" label="CPU" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.cpuSpeed" label="Speed CPU" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.gpu1" label="GPU" />
						</div>
						<div class="col-sm-6 col-xs-12" v-if="form.hasOwnProperty('gpu2')">
							<q-input dark outlined v-model="form.gpu2" label="GPU 2" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.storage1" label="Primary Storage" />
						</div>
						<div class="col-sm-6 col-xs-12" v-if="form.hasOwnProperty('storage2')">
							<q-input dark outlined v-model="form.storage2" label="Second Storage" />
						</div>
						<div class="col-sm-6 col-xs-12" v-if="form.hasOwnProperty('storage3')">
							<q-input dark outlined v-model="form.storage3" label="Third Storage" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-input dark outlined v-model="form.memoryRam" label="Memory RAM" />
						</div>
						<div class="col-sm-6 col-xs-12">
							<q-select
								dark
						...
						<div class="col-sm-6 col-xs-12">
							<q-input dark v-if="psu" outlined v-model="form.psu" label="Power Supply" />
						</div>
						<q-btn
							dark
							label="Save"
